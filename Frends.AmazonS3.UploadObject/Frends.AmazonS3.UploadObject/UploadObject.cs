...
public class AmazonS3
{
    ...
    /// <param name="options">Options parameters for error handling including ThrowErrorIfNoMatch, ThrowErrorOnFailure, and ErrorMessageOnFailure</param>
    /// <param name="cancellationToken">Token generated by Frends to stop this Task.</param>
    /// <returns>Object { bool Success, List&lt;string&gt; Objects, string DebugLog }</returns>
    public static async Task<Result> UploadObject([PropertyTab] Input input, [PropertyTab] Connection connection,
            ...
            foreach (var file in filesToCopy)
            {
                    ...
                    input.SourceDirectory.Split(Path.DirectorySeparatorChar).Length && input.PreserveFolderStructure)
                {
                    var subfolders = file.FullName.Replace(file.Name, "")
                        .Replace(input.SourceDirectory.Replace(file.Name, ""), "")
