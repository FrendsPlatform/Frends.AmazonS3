...
public class AmazonS3
{
    ...
    /// </summary>
    /// <param name="input">Input parameters containing the array of objects to delete and action on object not found behavior.</param>
    /// <param name="connection">Connection parameters including AWS credentials and region.</param>
    /// <param name="options">Optional parameters including timeout, error handling, and custom error messages.</param>
    /// <param name="cancellationToken">Token generated by Frends to stop this task.</param>
    /// <returns>Object { bool Success, List&lt;SingleResultObject&gt; DeletedObjects, Error Error }</returns>
